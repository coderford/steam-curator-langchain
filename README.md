...
An LLM-based steam game reviewer that parses through hundreds of steam user reviews to form an opinion. Generates a "Juice Score" based on various aspects like atmosphere, exploration, gameplay mechanics, challenge etc. FromSoftware Games will usually receive high scores.
